...
class Config:
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/znx_galaxy")
        self.SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/pookiezz_z")
        ...
        self.START_IMG = getenv("START_IMG", "https://ibb.co/LXkKtFp8")
